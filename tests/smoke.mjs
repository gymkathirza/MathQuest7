...
import {streakCoinMultiplier,coinsForCorrect,awardCorrectRewards,awardDayClearRewards,awardBreakBonus,buyBuilding,REALM_BUILDINGS,computeTrophies,heroTitle,XP_PER_CORRECT,COINS_DAY_CLEAR,COINS_BREAK_BONUS} from '../js/rewards.mjs';
...
assert.ok(/awardCorrectRewards|buyBuilding|awardBreakBonus/.test(appSource),'UI must award coins and support My Realm purchases');
...
console.log('PASS: 20 topics; benchmarks; mastery replay; open-ended focus; learner insights; GIF boost; mastery day log; coins/realm rewards; active practice timer');
