...
- Version: `0.21.0`
- Release label: `home-preview-parent-coins`
...
- Parent / Admin trophies row plus coins stat alongside XP/accuracy; **Award coins** card (50/100/200 presets + custom) persists via `save()` / `S.coins` only
