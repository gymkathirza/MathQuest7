...
- Version: `0.19.0`
- Release label: `realm-preview-pets`
...
- **My Realm** cosmetic shop: spend coins on 12 buildings, 5 pets, and pet skins; free **Preview** shows the item glowing in the main realm window for ~3.5s. Coins from correct answers (streak multiplies coins only), day clears (+100), and completed healthy breaks (+25). Rewards never unlock lessons or skip mastery
