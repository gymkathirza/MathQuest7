...
- Version: `0.16.0`
- Release label: `coach-boost-gif-visuals`
...
- `css/` — `app.css`.
- `js/` — `app.js`, `curriculum.mjs`, `daily-session.mjs`, `practice-timer.mjs`, `mastery-session.mjs`, `learner-insights.mjs`, `coach-visuals.mjs` (modules reference web-root files via `new URL('../file', import.meta.url)`).
