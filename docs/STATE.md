...
- Version: `0.18.0`
- Release label: `rewards-coins-realm`
...
- **My Realm** cosmetic shop: spend coins on 12 buildings; coins from correct answers (streak multiplies coins only), day clears (+100), and completed healthy breaks (+25). Rewards never unlock lessons or skip mastery
