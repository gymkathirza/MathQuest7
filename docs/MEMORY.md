...
- XP is permanent progress flavor (titles); **coins** are spendable cosmetic currency for **My Realm** buildings; **streak** multiplies coin payouts only (×1.5 at 5+, ×2 at 10+) and never replaces the 80% + exit-ticket unlock gate
